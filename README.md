# 🌟 Open Source Contributor Directory
...
1. Read our **[CONTRIBUTING.md](CONTRIBUTING.md)** for detailed instructions.
2. Add your entry to [`src/data/contributors.json`](src/data/contributors.json).
